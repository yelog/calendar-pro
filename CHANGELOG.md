...
### Added
- render real-height event timeline

### Changed
- supersede compact timeline design
- plan real-height event timeline
- design real-height event timeline
- add 0.2.1 release entry [skip ci]

## [0.2.1] - 2026-07-03

### Added
- render overlapping events side by side in popover

### Fixed
- surface overlapping date metadata in calendar
- distinguish holiday break subtitles
...
### Added
- add QWeather provider support with platform switching
- add QWeather setup guidance in settings UI

### Changed
- add MIT license
- add 0.1.7 release entry [skip ci]
- remove empty weather provider keys
- update README to reflect v0.1.7 features and project structure

### Fixed
- store QWeather key without keychain
- avoid AppKit layout reentry when sizing event detail and vacation guide panels

## [0.1.7] - 2026-05-18

### Added
- compact event indicator dots

### Changed
- refine calendar visual hierarchy
- refine calendar day emphasis

## [0.1.6] - 2026-05-14

### Added
- add phase end reminders
- add timer settings and statistics

### Changed
- refine calendar menu hierarchy
