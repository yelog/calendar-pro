...
当前仓库对应的已发布版本为 `0.1.7`，详细变更见 [CHANGELOG.md](./CHANGELOG.md)。
...
- **公历纪念日**：支持公历节日与纪念日展示。
- **天气**：支持当前天气与逐日天气预报，可按城市搜索，支持日期感知的预报切换，含温度、湿度、风速等详细气象指标。
...
- 位置权限：天气功能可按城市搜索，也可使用当前位置获取天气数据。
